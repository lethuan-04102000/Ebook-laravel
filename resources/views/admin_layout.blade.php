    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/backend/images/thuan.jpg')}}">
                <span class="username">
                	<?php
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/delivery')}}">Thêm Thông tin vận chuyển</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-category-product')}}">Thêm Danh Mục cho sách</a></li>
						<li><a href="{{URL::to('/all-category-product')}}">Danh sách các sách</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-brand-product')}}">Danh sách các nhà xuất bản</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-product')}}">Liệt Kê Các Đầu Sách</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/customer')}}">Danh sách khách hàng</a></li>
                    </ul>
                </li>
